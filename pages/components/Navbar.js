          ...
          <div className={`mx-auto max-w-7xl px-2 sm:px-6 lg:px-12 shadow-xl border-b-gray-500 border-b  ${theme== "light" ?  " bg-gray-50" : " bg-gray-800 "} `}>
            <div className="relative flex h-16 px-12 items-center justify-between ">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch  sm:justify-between">
                ...
                duration={1000}
                delay={100}
                className={`font-bold text-lg cursor-pointer  ${theme == "light" ? ' text-gray-800' : 'text-gray-100'}`}>Ceytive</Link>
              ...
              <label for="toggleB" class="flex items-center cursor-pointer">
                ...
                <div class="relative">
                  ...
                  <div class="dot absolute left-1 top-1 bg-white w-6 h-6 rounded-full flex justify-center  items-center transition">{theme == 'light' ? 'MD' : 'CI' }</div>
                </div>
